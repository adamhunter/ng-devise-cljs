...
var seq__24019_24023 = cljs.core.seq.call(null,clojure.browser.repl.print_queue);
var chunk__24020_24024 = null;
var count__24021_24025 = (0);
var i__24022_24026 = (0);
while(true){
if((i__24022_24026 < count__24021_24025)){
var str_24027 = cljs.core._nth.call(null,chunk__24020_24024,i__24022_24026);
clojure.browser.net.transmit.call(null,conn,new cljs.core.Keyword(null,"print","print",1299562414),str_24027);
...
var temp__4425__auto___24032 = cljs.core.seq.call(null,seq__24019_24023);
if(temp__4425__auto___24032){
var seq__24019_24033__$1 = temp__4425__auto___24032;
if(cljs.core.chunked_seq_QMARK_.call(null,seq__24019_24033__$1)){
var c__12383__auto___24034 = cljs.core.chunk_first.call(null,seq__24019_24033__$1);
var G__24035 = cljs.core.chunk_rest.call(null,seq__24019_24033__$1);
var G__24036 = c__12383__auto___24034;
var G__24037 = cljs.core.count.call(null,c__12383__auto___24034);
var G__24038 = (0);
...
var str_24039 = cljs.core.first.call(null,seq__24019_24033__$1);
clojure.browser.net.transmit.call(null,conn,new cljs.core.Keyword(null,"print","print",1299562414),str_24039);

var G__24040 = cljs.core.next.call(null,seq__24019_24033__$1);
var G__24041 = null;
var G__24042 = (0);
var G__24043 = (0);
...
var args24046 = [];
var len__12638__auto___24049 = arguments.length;
var i__12639__auto___24050 = (0);
while(true){
if((i__12639__auto___24050 < len__12638__auto___24049)){
args24046.push((arguments[i__12639__auto___24050]));

var G__24051 = (i__12639__auto___24050 + (1));
i__12639__auto___24050 = G__24051;
continue;
} else {
}
break;
...
return (function (){
if(cljs.core.truth_((function (){var and__11568__auto__ = clojure.browser.repl.load_queue;
...
var script__$1 = (function (){var G__24056 = script;
goog.object.set(G__24056,"type","text/javascript");

goog.object.set(G__24056,"onload",onload);

goog.object.set(G__24056,"onreadystatechange",onload);

return G__24056;
})();
var script__$2 = (((opt_sourceText == null))?(function (){var G__24057 = script__$1;
goog.object.set(G__24057,"src",src);

return G__24057;
})():(function (){var G__24058 = script__$1;
goog.dom.setTextContext(G__24058,opt_sourceText);
...
var reload_QMARK_ = (function (){var or__11580__auto__ = reload;
...
var path_24059 = (goog.dependencies_.nameToPath[src]);
goog.object.remove(goog.dependencies_.visited,path_24059);

goog.object.remove(goog.dependencies_.written,path_24059);

goog.object.remove(goog.dependencies_.written,[cljs.core.str(goog.basePath),cljs.core.str(path_24059)].join(''));
} else {
}
